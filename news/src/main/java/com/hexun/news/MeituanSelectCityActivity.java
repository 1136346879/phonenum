...
import com.hexun.news.decoration.DividerItemDecoration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHeaderAdapter = new HeaderRecyclerAndFooterWrapperAdapter(mAdapter) {
            ...
            protected void onBindHeaderHolder(ViewHolder holder, int headerPos, int layoutId, Object o) {
                ...
                } else if (layoutId == R.layout.meituan_item_header_top1) {
        ...
        mHeaderAdapter.setHeaderView(0, R.layout.meituan_item_header_top1, new MeituanTopHeaderBean("当前：上海徐汇"));
